...
type RestOf<T extends ITraining | NewTraining> = Omit<T, 'lastTrainingDate' | 'nextTrainingDate'> & {
...
export class TrainingService {
  ...
  protected convertDateFromServer(restTraining: RestTraining): ITraining {
    return {
      ...restTraining,
      lastTrainingDate: restTraining.lastTrainingDate ? dayjs(restTraining.lastTrainingDate) : undefined,
      nextTrainingDate: restTraining.nextTrainingDate ? dayjs(restTraining.nextTrainingDate) : undefined,
    };
  }
