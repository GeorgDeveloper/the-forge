...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../training.test-samples';

import { RestTraining, TrainingService } from './training.service';

const requireRestSample: RestTraining = {
  ...sampleWithRequiredData,
  lastTrainingDate: sampleWithRequiredData.lastTrainingDate?.format(DATE_FORMAT),
