...
import { sampleWithRequiredData } from '../job-description.test-samples';
...
describe('JobDescription Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.jobDescriptions()[0]).toEqual(expect.objectContaining({ id: 8232 }));
  });

  describe('trackId', () => {
    it('Should forward to jobDescriptionService', () => {
      const entity = { id: 8232 };
      jest.spyOn(service, 'getJobDescriptionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getJobDescriptionIdentifier).toHaveBeenCalledWith(entity);
